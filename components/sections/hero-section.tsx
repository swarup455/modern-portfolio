...
const socials = [
    { label: "GitHub", href: "https://github.com/swarup455", Icon: FaGithub },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/swarupdas1905/", Icon: FaLinkedin },
    { label: "YouTube", href: "https://www.youtube.com/@SWARUPDAS257", Icon: FaYoutube },
] as const;
            ...
            <div className="relative mx-auto w-full max-w-7xl px-6 py-20 lg:px-8">
                <div className="grid items-center gap-12 lg:grid-cols-[1fr_420px] lg:gap-16 xl:grid-cols-[1fr_460px]">
                    ...
                    >
                        ...
                        >
                            Computer Science Fresh Graduate and Backend Developer Intern with hands-on experience building scalable REST APIs, real-time applications, and AI-powered products using Node.js, Express.js, MongoDB, React, and Next.js.
                        </motion.p>
                        ...
                        >
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    link.href = "/finalresume_swarup.pdf";
                                    link.download = "Swarup_Das_Resume.pdf";
